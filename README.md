...
```
$ docker image tag metarab metarab/metarab
$ docker push metarab/metarab
```
...
```
$ kubectl get svc metarab -n metarab
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n metarab
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n metarab
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n metarab
```

and explore the details using

```
$ kubectl get svc exposed-registry -n metarab
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n metarab
```
